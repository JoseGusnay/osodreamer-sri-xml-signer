...
describe("CorpnewbestStrategy", () => {
  ...
  describe("supports", () => {
    ...
    it("debería retornar true con case insensitive", () => {
      expect(strategy.supports("corpnewbest cia ltda")).toBe(true);
    });
  ...
  describe("overrideIssuerName", () => {
    it("debería retornar el issuer name formateado", () => {
              ...
              issuer: {
                attributes: [
                  ...
                  },
                  {
                    shortName: "CN",
                    value:
                      "AUTORIDAD DE CERTIFICACION RAIZ CA-1EF CORPNEWBEST",
                  },
                ],
              },
            },
      ...
      expect(result).toBe(
        "CN=AUTORIDAD DE CERTIFICACION RAIZ CA-1EF CORPNEWBEST,OU=ENTIDAD DE CERTIFICACION DE INFORMACION,O=CORPNEWBEST CIA. LTDA.,C=EC"
      );
    });
  });
});
